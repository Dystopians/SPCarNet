...
- target compatibility view sharpness: `2.000000`
- target compatibility min view cosine: `-1.000000`
- target compatibility beta/floor: `0.150000` / `0.750000`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| best | 1.000000 | +0.045598 | +0.001964 | +0.000757 | +0.030165 | +0.001271 | +0.000246 | 0.877288 |
| best all-axis | 1.000000 | +0.045598 | +0.001964 | +0.000757 | +0.030165 | +0.001271 | +0.000246 | 0.877288 |

## Target Compatibility Diagnostics

| row | mean conf | p10 conf | mean risk | view gap | effective sources | unique sources |
|---|---:|---:|---:|---:|---:|---:|
| best | 0.966902 | 0.940959 | 0.976007 | 0.096960 | 6.471550 | 4.136908 |
| best all-axis | 0.966902 | 0.940959 | 0.976007 | 0.096960 | 6.471550 | 4.136908 |

## Teacher Projection At Selected Alpha

| scope | cosine | energy retention | changed fraction | residual PSNR |
|---|---:|---:|---:|---:|
| full surface | 0.302224 | 0.143385 | 0.205254 | 31.818708 |
| active surface | 0.307900 | 0.149007 | 0.232479 | 31.409137 |
...
- active bins: `57945`
- mean reliability: `0.025692`
- mean valid reliability: `0.170000`
- policy gain mode: `positive_soft`
- mean valid policy gain: `1.084801`
- max policy gain: `1.500000`
- mean valid tail risk: `0.799859`
- OOD gain mode: `off`
...
- JSON: `/data/peilincai/mesh-splatting/outputs/carnet/spcarnet_v289_targetcompat_20260630/v289a_soft_targetcompat_flowers/v253_deferred_source_renderer_audit.json`
- Markdown: `/data/peilincai/mesh-splatting/outputs/carnet/spcarnet_v289_targetcompat_20260630/v289a_soft_targetcompat_flowers/v253_deferred_source_renderer_audit.md`
- checkpoint: `/data/peilincai/mesh-splatting/outputs/carnet/spcarnet_v289_targetcompat_20260630/v289a_soft_targetcompat_flowers/v253_deferred_source_renderer_bank.npz`
- policy-val renders: `/data/peilincai/mesh-splatting/outputs/carnet/spcarnet_v289_targetcompat_20260630/v289a_soft_targetcompat_flowers/policy_val_best`
- target no-GT preview: `/data/peilincai/mesh-splatting/outputs/carnet/spcarnet_v289_targetcompat_20260630/v289a_soft_targetcompat_flowers/target_no_gt_preview`

## Target Exact Fixed-Policy Evaluation

| PSNR | SSIM | LPIPS | PSNR gain | SSIM gain | LPIPS gain | changed fraction |
|---:|---:|---:|---:|---:|---:|---:|
| 19.841450 | 0.620205 | 0.180094 | +0.009396 | +0.000294 | +0.000241 | 0.032547 |

- render dir: `/data/peilincai/mesh-splatting/outputs/carnet/spcarnet_v289_targetcompat_20260630/v289a_soft_targetcompat_flowers/target_exact_fixed_policy`
- Phase-J comparison: `{'reference': {'psnr': 20.304358, 'ssim': 0.55777, 'lpips': 0.329222}, 'candidate_psnr_minus_phasej': -0.4629081973686091, 'candidate_ssim_minus_phasej': 0.06243456384528767, 'phasej_lpips_minus_candidate': 0.1491283278734684, 'beats_phasej_all_axis_under_reported_metric_scale': False}`
