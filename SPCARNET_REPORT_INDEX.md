...
- `docs/car_model/6-26-v115-v106AnchoredEvidenceReparent-Implementation-Log.md`
...
16. `docs/car_model/6-26-v115-v106AnchoredEvidenceReparent-Implementation-Log.md`
17. `docs/car_model/vnext_artifacts/accepted_nonzero_qual_panels_20260626/cleanbest_qualitative_batch_summary.md`
18. `docs/car_model/vnext_artifacts/accepted_nonzero_qual_panels_20260626/garden_same_resolution_diagnostic/garden_target_parent_vs_vnext_same_resolution_summary.md`
19. `docs/car_model/vnext_artifacts/garden_effective_margin_gate_20260626/reports/garden_vnext_certified_residual_texture_report.md`
20. `docs/car_model/vnext_artifacts/strict_structure_aware_shrink_ready4_20260626_071413/strict_structure_aware_shrink_ready4_summary.md`
21. `docs/car_model/vnext_artifacts/strict_structure_aware_shrink_ready4_20260626_071413/strict_structure_aware_shrink_ready4_summary.json`
22. `docs/car_model/6-26-vNext-StumpInputRebuild-Ready5-and-Rejection-Log.md`
23. `docs/car_model/vnext_artifacts/full9_gap_after_stump_preflight_20260626/vnext_manifest_runner_summary.md`
24. `docs/car_model/vnext_artifacts/stump_structure_shrink_rebuild_tau002_20260626_080257/stump_vnext_certified_residual_texture_report.md`
25. `docs/car_model/6-26-vNext-TreehillInputRebuild-Ready6-and-Rejection-Log.md`
26. `docs/car_model/vnext_artifacts/full9_gap_after_treehill_preflight_20260626/vnext_manifest_runner_summary.md`
27. `docs/car_model/vnext_artifacts/treehill_structure_shrink_rebuild_tau002_20260626_0832/treehill_vnext_certified_residual_texture_report.md`
28. `docs/car_model/6-26-vNext-FlowersInputRebuild-Ready7-and-SameEvidenceFallback-Log.md`
29. `docs/car_model/vnext_artifacts/flowers_structure_shrink_rebuild_tau002_20260626_0935/flowers_vnext_certified_residual_texture_report.md`
30. `docs/car_model/vnext_artifacts/flowers_structure_shrink_rebuild_tau002_20260626_0935/preflight/vnext_manifest_runner_summary.md`
31. `docs/car_model/6-26-vNext-KitchenInputRebuild-Ready8-and-AcceptedMilestone-Log.md`
32. `docs/car_model/vnext_artifacts/kitchen_structure_shrink_rebuild_tau002_20260626_1023/kitchen_vnext_certified_residual_texture_report.md`
33. `docs/car_model/vnext_artifacts/kitchen_structure_shrink_rebuild_tau002_20260626_1023/preflight/vnext_manifest_runner_summary.md`
34. `docs/car_model/6-26-vNext-BicycleInputRebuild-Ready9-and-Full9InputClosure-Log.md`
35. `docs/car_model/vnext_artifacts/bicycle_structure_shrink_rebuild_tau002_20260626_1055/reports/bicycle_vnext_certified_residual_texture_report.md`
36. `docs/car_model/vnext_artifacts/bicycle_structure_shrink_rebuild_tau002_20260626_1055/preflight/vnext_manifest_runner_summary.md`
37. `docs/car_model/vnext_artifacts/vnext_structure_shrink_ready4_preflight_20260626.md`
38. `docs/car_model/vnext_artifacts/vnext_structure_shrink_ready4_preflight_20260626.json`
39. `docs/car_model/vnext_artifacts/vnext_structure_shrink_full9_gap_preflight_20260626.md`
40. `docs/car_model/vnext_artifacts/vnext_structure_shrink_full9_gap_preflight_20260626.json`
41. `docs/car_model/vnext_artifacts/vnext_structure_shrink_ready4_scene_config_20260626.json`
42. `docs/car_model/vnext_artifacts/vnext_structure_shrink_full9_gap_scene_config_20260626.json`
43. `docs/car_model/vnext_artifacts/strict_structure_aware_shrink_multiscene_20260626_0718/strict_structure_aware_shrink_multiscene_summary.md`
44. `docs/car_model/6-26-SPCarNet-vNext-Feasibility-And-Execution-Plan.md`
45. `docs/car_model/6-26-SPCarNet-vNext-SoftShrink-Garden-Milestone-Log.md`
46. `docs/car_model/6-26-SPCarNet-vNext-Technical-Report-And-Index.zh.md`
47. `docs/car_model/vnext_artifacts/README.md`
48. `docs/car_model/6-25-SPCarNet-Cloneable-Report-Index.md`
49. `docs/car_model/6-25-SPCarNet-PPT-Technical-Report-Current.md`
50. `docs/car_model/6-25-SPCarNet-Mentor-Technical-Report.md`
51. `docs/car_model/6-25-v113b-OOT-Tail-Safe-Gate-Log.md`
52. `docs/car_model/6-25-v113c-FrameFallback-and-v114-OOFRefit-Log.md`
53. `docs/car_model/results/v106_podmoe_basepreserve_full9_20260625/full9_compare.md`
54. `docs/car_model/results/v113_oot_tail_20260625/summary/v113b_oot_tail_safe_summary.md`
55. `docs/car_model/results/v113c_frame_fallback_v114_oof_20260625/summary/v113c_v114_summary.md`
56. `docs/car_model/results/v110_strict_split_20260625/summary/v110b_manual_flowers_garden_summary.md`
57. `docs/car_model/results/v110_v111_v114_strict_branch_20260625/summary/spcarnet_v110_v111_v114_package.md`
58. `docs/car_model/README.md`
...
- `v114_oof_refit_pod_moe` is blocked as an artifact/provenance issue: the field exists, but the original detached model package is missing `cfg_args`, and substituting another model is correctly rejected by endpoint-hash safety.
...
- v115 now has an implemented evidence-reparent interface for v106-anchored residual distillation: `ecsr_reparent_surface_evidence_cache.py` plus `run_vnext_certified_residual_texture_scene.py --reparent_fit_parent_render_dir/--reparent_target_parent_render_dir`. It has passed synthetic reparent smoke and scene-runner dry-run checks, but it is not yet a metric result because v106-compatible parent renders still need to be restored or regenerated.
