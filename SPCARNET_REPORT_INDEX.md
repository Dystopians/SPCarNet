...
20. `docs/car_model/vnext_artifacts/vnext_structure_shrink_ready4_preflight_20260626.md`
21. `docs/car_model/vnext_artifacts/vnext_structure_shrink_ready4_preflight_20260626.json`
22. `docs/car_model/vnext_artifacts/vnext_structure_shrink_full9_gap_preflight_20260626.md`
23. `docs/car_model/vnext_artifacts/vnext_structure_shrink_full9_gap_preflight_20260626.json`
24. `docs/car_model/vnext_artifacts/vnext_structure_shrink_ready4_scene_config_20260626.json`
25. `docs/car_model/vnext_artifacts/vnext_structure_shrink_full9_gap_scene_config_20260626.json`
26. `docs/car_model/vnext_artifacts/strict_structure_aware_shrink_multiscene_20260626_0718/strict_structure_aware_shrink_multiscene_summary.md`
27. `docs/car_model/6-26-SPCarNet-vNext-Feasibility-And-Execution-Plan.md`
28. `docs/car_model/6-26-SPCarNet-vNext-SoftShrink-Garden-Milestone-Log.md`
29. `docs/car_model/6-26-SPCarNet-vNext-Technical-Report-And-Index.zh.md`
30. `docs/car_model/vnext_artifacts/README.md`
31. `docs/car_model/6-25-SPCarNet-Cloneable-Report-Index.md`
32. `docs/car_model/6-25-SPCarNet-PPT-Technical-Report-Current.md`
33. `docs/car_model/6-25-SPCarNet-Mentor-Technical-Report.md`
34. `docs/car_model/6-25-v113b-OOT-Tail-Safe-Gate-Log.md`
35. `docs/car_model/6-25-v113c-FrameFallback-and-v114-OOFRefit-Log.md`
36. `docs/car_model/results/v106_podmoe_basepreserve_full9_20260625/full9_compare.md`
37. `docs/car_model/results/v113_oot_tail_20260625/summary/v113b_oot_tail_safe_summary.md`
38. `docs/car_model/results/v113c_frame_fallback_v114_oof_20260625/summary/v113c_v114_summary.md`
39. `docs/car_model/results/v110_strict_split_20260625/summary/v110b_manual_flowers_garden_summary.md`
40. `docs/car_model/results/v110_v111_v114_strict_branch_20260625/summary/spcarnet_v110_v111_v114_package.md`
41. `docs/car_model/README.md`
...
- Latest local rebuilds: `stump`, `treehill`, and `flowers` fit/target evidence plus policy-val pruned carriers were rebuilt under `/dev/shm`, moving local preflight to `7 / 9` input-ready. All three strict runs completed with W&B offline and protocol pass, but the certificate rejected them to exact fallback/no-op: `stump` failed tail risk (`cvar20_view_relative_gain=-0.172454`, `min_view_relative_gain=-0.344907`), `treehill` failed lower-tail/SSIM/L1 gates (`cvar20_view_relative_gain=-0.053640`, `min_view_relative_gain=-0.077837`, `ssim_gain=-0.000009413`), and `flowers` failed lower-tail/SSIM/L1 gates (`cvar20_view_relative_gain=-0.224441`, `min_view_relative_gain=-0.278408`, `ssim_gain=-0.000082279`). The flowers same-evidence parent export matches fallback exactly at `19.519194 / 0.490780 / 0.424170`, confirming the rebuilt `images_2` evidence comparison is fair. Remaining missing-input scenes are `bicycle,kitchen`.
