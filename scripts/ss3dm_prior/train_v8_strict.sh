...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT/outputs/ss3dm_prior/train_full_v8_strict}"
...
python -m ss3dm_prior.train \
  ...
  --train_config "$ROOT/configs/ss3dm_prior/train_v8_strict.yaml" \
  ...
  --run_name "ss3dm_prior_full_v8_strict" \
