...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT/outputs/ss3dm_prior/train_v8_hybrid}"
WANDB_MODE="${WANDB_MODE:-offline}"

python -m ss3dm_prior.train \
  --data_config "$ROOT/configs/ss3dm_prior/data_default.yaml" \
  --model_config "$ROOT/configs/ss3dm_prior/model_v8_hybrid.yaml" \
  --train_config "$ROOT/configs/ss3dm_prior/train_v8_hybrid.yaml" \
  ...
  --run_name "ss3dm_prior_v8_hybrid" \
