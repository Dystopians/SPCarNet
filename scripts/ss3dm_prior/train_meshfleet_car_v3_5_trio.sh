...
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/outputs/ss3dm_prior_car/v3_5_ablations}"
...
launch_variant() {
  ...
  local model_cfg="$4"
  local train_cfg="$5"
  local run_name="ss3dm_prior_car_${variant}"
...
echo "[logs] $OUTPUT_ROOT/logs/v3_5_baseline.log"
echo "[logs] $OUTPUT_ROOT/logs/v3_5_occ.log"
echo "[logs] $OUTPUT_ROOT/logs/v3_5_occ_vq.log"
