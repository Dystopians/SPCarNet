...
MODEL_ROOT="${MODEL_ROOT:-outputs/carnet/meshprior/stageF63_parking_adaptive_order_preserving_arbitrated_policy_7000/parking_${ITERATIONS}iter_adaptive_order_preserving_arbitrated_policy}"
...
WANDB_GROUP="${WANDB_GROUP:-final_stageF63_parking_adaptive_order_preserving_arbitrated_policy_7000}"
WANDB_NAME="${WANDB_NAME:-F63_parking_${ITERATIONS}_adaptive_order_preserving_arbitrated_policy}"
SCENE_NAME="${SCENE_NAME:-F63_parking_${ITERATIONS}_adaptive_order_preserving_arbitrated_policy}"
PRISM_GEOMETRY_ACQ_UNTIL_ITER="${PRISM_GEOMETRY_ACQ_UNTIL_ITER:-1400}"
PRISM_STATS_COLLECTION_ITERS="${PRISM_STATS_COLLECTION_ITERS:-100}"
PRISM_CANDIDATE_PRUNE_RATIO="${PRISM_CANDIDATE_PRUNE_RATIO:-0.012}"
...
TRAIN_CMD=(
  ...
  --prism_enable_adaptive_csef_policy
  --prism_adaptive_policy_initial_ratio 0.012
  --prism_adaptive_policy_min_ratio 0.006
  --prism_adaptive_policy_max_ratio 0.020
  --prism_adaptive_policy_min_candidate_count 512
  --prism_adaptive_policy_reliable_absrel_max 2.0
  --prism_adaptive_policy_depth_degrade_absrel 0.004
  --prism_adaptive_policy_normal_degrade_deg 0.10
  --prism_adaptive_policy_render_degrade_psnr -0.05
  --prism_adaptive_policy_cooldown_iters 20
  --prism_adaptive_policy_cold_start_rounds 1
  --prism_adaptive_policy_cold_start_gate_scale 0.70
  --prism_adaptive_policy_cold_start_ratio_damping 0.96
  --prism_adaptive_policy_enable_measured_rank
  --prism_adaptive_policy_enable_microbatch_gate
  --prism_adaptive_policy_microbatch_size 512
  --prism_adaptive_policy_microbatch_max_batches 0
