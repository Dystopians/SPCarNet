#!/usr/bin/env bash
# CarNet_v0.2 training launcher — 150 epoch full run on the combined
# MeshFleet + Objaverse-1.0 cache (meshfleet_car_cache_v5).
...
MODEL_CONFIG="${MODEL_CONFIG:-$ROOT/configs/ss3dm_prior/carnet_v0_2/model_carnet_v0_2.yaml}"
TRAIN_CONFIG="${TRAIN_CONFIG:-$ROOT/configs/ss3dm_prior/carnet_v0_2/train_carnet_v0_2.yaml}"
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/outputs/carnet/v0_2}"
RUN_NAME="${RUN_NAME:-carnet_v0_2}"
...
LOG_PATH="${LOG_PATH:-$OUTPUT_ROOT/logs/carnet_v0_2.log}"
