...
MODEL_ROOT="${MODEL_ROOT:-outputs/carnet/meshprior/stageF62_parking_adaptive_arbitrated_policy_7000/parking_${ITERATIONS}iter_adaptive_arbitrated_policy}"
...
WANDB_GROUP="${WANDB_GROUP:-final_stageF62_parking_adaptive_arbitrated_policy_7000}"
WANDB_NAME="${WANDB_NAME:-F62_parking_${ITERATIONS}_adaptive_arbitrated_policy}"
SCENE_NAME="${SCENE_NAME:-F62_parking_${ITERATIONS}_adaptive_arbitrated_policy}"
