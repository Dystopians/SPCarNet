...
MODEL_ROOT="${MODEL_ROOT:-outputs/carnet/meshprior/stageF57_parking_adaptive_csef_policy_7000/parking_${ITERATIONS}iter_adaptive_csef_policy}"
...
WANDB_GROUP="${WANDB_GROUP:-final_stageF57_parking_adaptive_csef_policy_7000}"
WANDB_NAME="${WANDB_NAME:-F57_parking_${ITERATIONS}_adaptive_csef_policy}"
SCENE_NAME="${SCENE_NAME:-F57_parking_${ITERATIONS}_adaptive_csef_policy}"
