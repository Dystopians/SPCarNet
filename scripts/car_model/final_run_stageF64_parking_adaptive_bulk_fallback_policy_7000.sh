...
MODEL_ROOT="${MODEL_ROOT:-outputs/carnet/meshprior/stageF64_parking_adaptive_bulk_fallback_policy_7000/parking_${ITERATIONS}iter_adaptive_bulk_fallback_policy}"
...
WANDB_GROUP="${WANDB_GROUP:-final_stageF64_parking_adaptive_bulk_fallback_policy_7000}"
WANDB_NAME="${WANDB_NAME:-F64_parking_${ITERATIONS}_adaptive_bulk_fallback_policy}"
SCENE_NAME="${SCENE_NAME:-F64_parking_${ITERATIONS}_adaptive_bulk_fallback_policy}"
