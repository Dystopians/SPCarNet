...
MODEL_ROOT="${MODEL_ROOT:-outputs/carnet/meshprior/stageF60_parking_adaptive_geom_pareto_policy_7000/parking_${ITERATIONS}iter_adaptive_geom_pareto_policy}"
...
WANDB_GROUP="${WANDB_GROUP:-final_stageF60_parking_adaptive_geom_pareto_policy_7000}"
WANDB_NAME="${WANDB_NAME:-F60_parking_${ITERATIONS}_adaptive_geom_pareto_policy}"
SCENE_NAME="${SCENE_NAME:-F60_parking_${ITERATIONS}_adaptive_geom_pareto_policy}"
