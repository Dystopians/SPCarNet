...
MODEL_ROOT="${MODEL_ROOT:-outputs/carnet/meshprior/stageF50_parking_calibrated_gate_ratio004_7000/parking_${ITERATIONS}iter_ratio004_calibrated_gate}"
...
WANDB_GROUP="${WANDB_GROUP:-final_stageF50_parking_calibrated_gate_ratio004_7000}"
WANDB_NAME="${WANDB_NAME:-F50_parking_ratio004_${ITERATIONS}_calibrated_gate}"
...
TRAIN_CMD=(
  ...
  --scene_name "F50_parking_ratio004_${ITERATIONS}_calibrated_gate"
  --enable_wandb
  ...
  --prism_candidate_prune_ratio_per_round 0.04
