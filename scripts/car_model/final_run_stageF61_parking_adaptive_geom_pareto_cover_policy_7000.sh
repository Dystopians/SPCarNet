...
MODEL_ROOT="${MODEL_ROOT:-outputs/carnet/meshprior/stageF61_parking_adaptive_geom_pareto_cover_policy_7000/parking_${ITERATIONS}iter_adaptive_geom_pareto_cover_policy}"
...
WANDB_GROUP="${WANDB_GROUP:-final_stageF61_parking_adaptive_geom_pareto_cover_policy_7000}"
WANDB_NAME="${WANDB_NAME:-F61_parking_${ITERATIONS}_adaptive_geom_pareto_cover_policy}"
SCENE_NAME="${SCENE_NAME:-F61_parking_${ITERATIONS}_adaptive_geom_pareto_cover_policy}"
