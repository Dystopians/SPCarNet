...
NEGATIVE_ROWS = [
    ...
    {"scene": "bonsai", "row": "real gate-removed ratio0.02 7000", "finding": "F43 is a negative long-budget gate-generalization result: gate-on rolls back all six candidate rounds while gate-off commits all six, and no-gate wins PSNR, SSIM, LPIPS, AbsRel, Depth MAE, and normal with fewer triangles", "evidence": "docs/car_model/final_stageF43_bonsai_gate_removed_7000_report.md"},
    {"scene": "bonsai", "row": "calibrated gate ratio0.02 7000", "finding": "F44 repairs the F43 strict-gate weakness: calibrated gate commits three recoverable rounds, rejects three later rounds, beats strict gate by large margins on every tracked metric, and finishes close to no-gate with fewer triangles", "evidence": "docs/car_model/final_stageF44_bonsai_calibrated_gate_7000_report.md"},
