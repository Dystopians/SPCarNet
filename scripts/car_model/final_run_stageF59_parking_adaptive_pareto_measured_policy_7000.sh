...
MODEL_ROOT="${MODEL_ROOT:-outputs/carnet/meshprior/stageF59_parking_adaptive_pareto_measured_policy_7000/parking_${ITERATIONS}iter_adaptive_pareto_measured_policy}"
...
WANDB_GROUP="${WANDB_GROUP:-final_stageF59_parking_adaptive_pareto_measured_policy_7000}"
WANDB_NAME="${WANDB_NAME:-F59_parking_${ITERATIONS}_adaptive_pareto_measured_policy}"
SCENE_NAME="${SCENE_NAME:-F59_parking_${ITERATIONS}_adaptive_pareto_measured_policy}"
