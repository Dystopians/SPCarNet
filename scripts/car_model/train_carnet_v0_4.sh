#!/usr/bin/env bash
# CarNet_v0.4 launcher — loss + corruption probe on v0.2 architecture.
...
MODEL_CONFIG="${MODEL_CONFIG:-$ROOT/configs/ss3dm_prior/carnet_v0_4/model_carnet_v0_4.yaml}"
TRAIN_CONFIG="${TRAIN_CONFIG:-$ROOT/configs/ss3dm_prior/carnet_v0_4/train_carnet_v0_4.yaml}"
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/outputs/carnet/v0_4}"
RUN_NAME="${RUN_NAME:-carnet_v0_4}"
