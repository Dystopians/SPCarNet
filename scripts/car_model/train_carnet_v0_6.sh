#!/usr/bin/env bash
# CarNet_v0.6 launcher — explicit visible/hidden chamfer split on v0.2 arch.
...
MODEL_CONFIG="${MODEL_CONFIG:-$ROOT/configs/ss3dm_prior/carnet_v0_6/model_carnet_v0_6.yaml}"
TRAIN_CONFIG="${TRAIN_CONFIG:-$ROOT/configs/ss3dm_prior/carnet_v0_6/train_carnet_v0_6.yaml}"
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/outputs/carnet/v0_6}"
RUN_NAME="${RUN_NAME:-carnet_v0_6}"
