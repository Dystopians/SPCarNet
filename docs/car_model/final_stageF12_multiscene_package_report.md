...
| bonsai | CSEF50 + sparse-depth + LPIPS validation-budget repair | all-metric clean-long win with 50 percent topology reduction; this repairs the fixed-CSEF50 LPIPS miss and the CSEF20 Depth MAE miss without switching to QEM | `docs/car_model/final_stageF47_F48_csef_family_all_metric_repair_report.md` |
