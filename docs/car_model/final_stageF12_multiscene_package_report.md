...
| parking_phone_tiny | calibrated gate ratio0.04 7000 | F50 is a mixed replication: calibrated gate still rolls back the same no-accept candidate as strict gate, beats no-gate on render metrics, improves sparse geometry proxies relative to strict gate, but does not prove broad calibrated-gate superiority | `docs/car_model/final_stageF50_parking_calibrated_gate_ratio004_7000_report.md` |
