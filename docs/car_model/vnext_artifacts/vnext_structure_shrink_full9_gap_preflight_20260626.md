...
- output root: `/dev/shm/peilincai_vnext_manifest_full9_gap_preflight_20260626_repo`
- preflight-only: `True`
- max parallel: `1`
- ready scenes: `4`
- missing-input scenes: `5`
- failed scenes: `0`
...
| stump | MISSING_INPUT | False |  | 0.000 | 3 | `` |
| treehill | MISSING_INPUT | False |  | 0.000 | 2 | `` |
...
- `stump`: fit_evidence_dir, target_evidence_dir, region_carrier_json
- `treehill`: fit_evidence_dir, target_evidence_dir, region_carrier_json
