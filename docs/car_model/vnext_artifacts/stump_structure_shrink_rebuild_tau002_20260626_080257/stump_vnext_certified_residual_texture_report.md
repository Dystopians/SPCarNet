...
- scene: `stump`
- status: `COMPLETE`
- run root: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_stump_strict_20260626/stump`
...
- adapter_target_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_stump_strict_20260626/stump/target_evidence_no_gt` exists=`False`
- fit_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/stump/fit_evidence` exists=`True`
- parent_render_dir: `None`
- region_carrier_json: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/stump/carrier.json` exists=`True`
- source_model: `outputs/carnet/meshsplatopt/ecsr_phase_f/policy_val_compaction_ladder_v2_envfix/stump/ratio_0200/compact_model` exists=`True`
- stripped_target_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_stump_strict_20260626/stump/target_evidence_no_gt` exists=`False`
- target_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/stump/target_evidence` exists=`True`
- teacher_render_dir: `None`
- texture_fit_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/stump/fit_evidence` exists=`True`
...
- no_policy_val_bin_uncertainty_guard: `False`
...
- output_root: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_stump_strict_20260626`
...
- wandb: `True`
- wandb_group: `vnext_structure_shrink_missing_inputs_20260626`
- wandb_mode: `offline`
- wandb_name: `stump_structure_shrink_strict_after_input_rebuild`
