...
- scene: `bicycle`
- status: `COMPLETE`
- run root: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_bicycle_strict_20260626_1055/bicycle`
...
- adapter_target_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_bicycle_strict_20260626_1055/bicycle/target_evidence_no_gt` exists=`False`
- fit_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/bicycle/fit_evidence` exists=`True`
- parent_render_dir: `None`
- region_carrier_json: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/bicycle/carrier.json` exists=`True`
- source_model: `outputs/carnet/meshsplatopt/ecsr_phase_f/policy_val_compaction_ladder_v2_envfix/bicycle/ratio_0200/compact_model` exists=`True`
- stripped_target_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_bicycle_strict_20260626_1055/bicycle/target_evidence_no_gt` exists=`False`
- target_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/bicycle/target_evidence` exists=`True`
- teacher_render_dir: `None`
- texture_fit_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/bicycle/fit_evidence` exists=`True`
...
- output_root: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_bicycle_strict_20260626_1055`
...
- wandb_mode: `offline`
- wandb_name: `bicycle_structure_strict_20260626_1055`
