...
- scene: `counter`
- status: `COMPLETE`
- run root: `/dev/shm/peilincai_spcarnet_vnext_full9_margin_gate_20260626_1500/counter`
...
- adapter_target_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_full9_margin_gate_20260626_1500/counter/target_evidence_no_gt` exists=`False`
...
- stripped_target_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_full9_margin_gate_20260626_1500/counter/target_evidence_no_gt` exists=`False`
...
- wandb_mode: `offline`
- wandb_name: `vnext-margin-full9-counter`
