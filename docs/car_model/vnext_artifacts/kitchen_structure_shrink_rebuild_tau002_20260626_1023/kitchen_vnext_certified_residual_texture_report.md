...
- scene: `kitchen`
- status: `COMPLETE`
- run root: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_kitchen_strict_20260626_1023/kitchen`
...
- adapter_target_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_kitchen_strict_20260626_1023/kitchen/target_evidence_no_gt` exists=`False`
- fit_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/kitchen/fit_evidence` exists=`True`
- parent_render_dir: `None`
- region_carrier_json: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/kitchen/carrier.json` exists=`True`
- source_model: `outputs/carnet/meshsplatopt/ecsr_phase_f/policy_val_compaction_ladder_v2_envfix/kitchen/ratio_0200/compact_model` exists=`True`
- stripped_target_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_kitchen_strict_20260626_1023/kitchen/target_evidence_no_gt` exists=`False`
- target_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/kitchen/target_evidence` exists=`True`
- teacher_render_dir: `None`
- texture_fit_evidence_dir: `/dev/shm/peilincai_spcarnet_vnext_full9_inputs_20260626/kitchen/fit_evidence` exists=`True`
...
- output_root: `/dev/shm/peilincai_spcarnet_vnext_structure_shrink_kitchen_strict_20260626_1023`
...
- wandb_mode: `offline`
- wandb_name: `kitchen_structure_strict_20260626_1023`
