...
| S-GEO/S-DOWN | SS3DM ≥4 seqs + toy_parking + 1–2 variants | **BLOCKED: SS3DM not on disk — acquisition cell D-1 below**; toy READY |
| S-GEN | 1–2 unseen-type (T&T barn/truck on disk) | READY (data); needs B0 training |

## Cells
| cell | tier | scope | status | notes |
|---|---|---|---|---|
| D-1 SS3DM acquisition | T1-blocking | download/verify ≥4 seqs + GT meshes | TODO | ~? GB; /data has 1.1T; if unobtainable → INFEASIBLE note + human approval, S-GEO falls back to toy variants + courtyard |
| D-2 toy variants ×2 | T1 | builder re-runs, altered layout/occlusion | TODO | tools/gems/build_toy_parking.py parameterization |
| E1-PARETO S-REND | T1 | {50,25,12.5} × {B2,B3,B4,B5} × 9 scenes (+B6,B7 diagnostic on 2 scenes) | B50 slice DONE-PASS (B5 within −0.10: 8/9 scenes incl. garden, ABOVE clean 5/9, LPIPS better 9/9; flowers −0.147 → E9-FAIL; B4 within −0.20: 8/9). B25 batch RUNNING | garden rows exist from Stage One |
