...
| R1 row | T1 | 3DGS + public compression at matched storage | TODO-FEASIBLE (GOAL #013 feasibility check: NO 3DGS anywhere on machine; setup ~20–40 min compile + ~0.5 day wall-clock total for full9 + LightGaussian → UNDER the 1-day INFEASIBLE bar; execution = future pre-registered goal; env-hygiene flag: build in a SEPARATE env, human ack requested) | `analysis/r1_3dgs_feasibility/r1_feasibility_note.md` |
