...
The following panels are generated from real held-out renders. The selected views are the strongest diverse per-view improvements under the same score used for baseline selection.
...
Local crops are selected automatically from regions where clean MeshSplatting has higher error than SPCarNet. These crops make the visual effect easier to inspect than full-frame metrics alone.

<p align="center">
  <img src="assets/spcarnet_m360_full9_crop_gallery.png" width="980" alt="SPCarNet local crop comparison against clean MeshSplatting">
</p>
